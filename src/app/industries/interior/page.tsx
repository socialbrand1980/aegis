...
export const metadata: Metadata = {
  title: "Industry: Interior",
  description: "Automasi qualification dan planning call untuk bisnis interior design dan kontraktor."
};

export default function InteriorPage() {
  const industry = industries.find((item) => item.slug === "interior");
