...
export const metadata: Metadata = {
  title: "Industry: Software House",
  description: "Standarisasi discovery dan nurture sequence untuk software house B2B."
};

export default function SoftwareHousePage() {
  const industry = industries.find((item) => item.slug === "software-house");
