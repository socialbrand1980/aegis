...
export const metadata: Metadata = {
  ...
  description: "Bagaimana consultant firm menstandarkan lead qualification dan meeting quality dengan Aegis AI."
};

export default function ConsultantPage() {
  const industry = industries.find((item) => item.slug === "consultant");
