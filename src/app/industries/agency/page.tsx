...
export const metadata: Metadata = {
  title: "Industry: Agency",
  description: "Bagaimana Aegis AI membantu agency meningkatkan response speed, call quality, dan retainer pipeline."
};

export default function AgencyPage() {
  const industry = industries.find((item) => item.slug === "agency");
